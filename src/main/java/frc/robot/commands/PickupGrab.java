...
public class PickupGrab extends SequentialCommandGroup {
  ...
  public PickupGrab(ArmGripper gripper) {
    ...
    addCommands(new PickupThenExtend(gripper, false), new AutoClose(gripper)); //Commands.waitSeconds(0.5),new PickupPullback(gripper)); //new MoveArmProfiled(gripper, "PickToStow"));
  }
}
